...
Provide a local operator loop that verifies an approved local markdown source can be preflighted, ingested, indexed, and retrieval-smoked as a provider-visible RAG source.
