## 1. Smoke Evidence Helper

- [x] 1.1 Add a Qdrant smoke report model and JSON/Markdown renderers.
- [x] 1.2 Implement a helper that indexes sources and queries benchmark cases with one Qdrant client.
- [x] 1.3 Add a CLI script for exporting Qdrant + BGE-M3 smoke evidence.
