...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Export aggregate real-business corpus golden cases.",
    )
    parser.add_argument("--case-file", type=Path, default=DEFAULT_AGGREGATE_CASE_FILE)
    ...
    print(f"Real business corpus golden cases JSON ready: {report.json_path}")
    print(f"Real business corpus golden cases Markdown ready: {report.markdown_path}")
