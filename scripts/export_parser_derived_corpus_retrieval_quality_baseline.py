...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Export parser-derived corpus retrieval quality baseline.",
    )
    ...
    print(f"Parser-derived corpus quality JSON ready: {report.json_path}")
    print(f"Parser-derived corpus quality Markdown ready: {report.markdown_path}")
