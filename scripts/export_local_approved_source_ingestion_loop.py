...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the local approved-source ingestion loop.",
    )
    ...
    print(f"Local approved-source ingestion loop JSON ready: {report.json_path}")
    print(f"Local approved-source ingestion loop Markdown ready: {report.markdown_path_out}")
