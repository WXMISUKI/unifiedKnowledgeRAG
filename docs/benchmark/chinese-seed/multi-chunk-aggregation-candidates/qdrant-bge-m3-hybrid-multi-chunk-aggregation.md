...
| created_at | 2026-05-30T05:18:24.241447+00:00 |
...
| --- | --- | ---: | --- |
| split_refund_policy_docs | hybrid_smoke_9fe2711d0806486680c6c79174178247 | 2 | ready |

## Gated Summary

| Backend | Total Cases | Hit Rate | Citation Match Rate | Empty Handling Rate |
| --- | ---: | ---: | ---: | ---: |
| qdrant-hybrid:source-document-identifier-coverage-v1 | 1 | 1.0000 | 1.0000 | 0.0000 |
