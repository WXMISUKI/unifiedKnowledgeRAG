...
- Generated At: `2026-06-09T04:16:09.870374+00:00`
- Source ID: `split_refund_policy_docs`
- Case File: `docs\local-run\business-rag-golden-cases\onboarding\split_refund_policy_docs\baseline-pack.fixture.json`
...
|---|---|---|---|---|---|
| `split-policy-code` | `policy_code_lookup` | `answerable` | `ready` | `answerable_case_passed` | `split_refund_policy_2026#policy-code` |
| `split-form-material` | `form_lookup` | `answerable` | `ready` | `answerable_case_passed` | `split_refund_policy_2026#form-code` |
| `split-negative-offline-subsidy` | `negative_control` | `insufficient_evidence` | `ready` | `negative_control_passed` | `` |
