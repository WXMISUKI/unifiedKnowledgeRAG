...
- Generated At: `2026-06-09T07:19:08.234994+00:00`
- Source ID: `source_template_example`
- Case File: `docs\local-run\business-rag-golden-cases\onboarding\source_template_example\baseline-pack.fixture.json`
...
|---|---|---|---|---|---|
| `template-example-review-time` | `review_time_lookup` | `answerable` | `ready` | `answerable_case_passed` | `source_template_example_2026#initial-review, source_template_example_2026#required-fields` |
| `template-example-required-fields` | `required_fields_lookup` | `answerable` | `ready` | `answerable_case_passed` | `source_template_example_2026#required-fields, source_template_example_2026#initial-review` |
| `template-example-negative-procurement-flow` | `negative_control` | `insufficient_evidence` | `ready` | `negative_control_passed` | `` |
