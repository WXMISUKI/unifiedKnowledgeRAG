...
- Generated At: `2026-06-06T11:31:39.632715+00:00`
...
| Artifact | Path |
|---|---|
| `trial_report` | `D:\AI\AIcode\unifiedKnowledgeRAG\docs\local-run\business-corpus-trial\local-business-corpus-trial.json` |
| `markdown` | `D:\AI\AIcode\unifiedKnowledgeRAG\docs\local-run\pdf-derived-corpus\company_profile_2025_trial.md` |
| `overlay` | `docs\local-run\business-corpus-trial\local-business-corpus-source.json` |
| `chunks` | `docs\local-run\business-corpus-trial\local-business-corpus-chunks.json` |
