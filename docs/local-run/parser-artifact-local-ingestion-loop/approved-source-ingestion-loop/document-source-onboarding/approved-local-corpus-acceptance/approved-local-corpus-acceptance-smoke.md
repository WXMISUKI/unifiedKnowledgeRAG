...
- Generated At: `2026-06-07T09:19:19.881257+00:00`
...
|---|---|---|---|---|---|---|
| `business_scope` | `answerable` | `ready` | `2` | `answered` | `2` | `0` |
| `qualifications` | `answerable` | `ready` | `2` | `answered` | `2` | `0` |
| `organization` | `answerable` | `ready` | `2` | `answered` | `2` | `0` |
| `project_scale` | `answerable` | `ready` | `2` | `answered` | `2` | `0` |
