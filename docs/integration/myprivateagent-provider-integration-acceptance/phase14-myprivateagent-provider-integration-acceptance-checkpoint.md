...
| `trial_readiness` | `ready_for_myprivateagent_repo_side_trial` |
...
| `review_signals` | `3` |
| `blocked_signals` | `0` |
| `ready_signal_ids` | `["provider_contract_smoke", "phase10_myprivateagent_local_consumer_probe", "phase11_provider_discovery_smoke", "phase11_rag_retrieve_consumption_smoke", "phase11_source_binding_preview_smoke", "provider_handoff_bundle", "provider_handoff_refresh"]` |
