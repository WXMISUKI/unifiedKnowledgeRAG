...
- Requested Capabilities: `knowledge.rag.source_documents, knowledge.rag.retrieve, knowledge.rag.answer, knowledge.provider.source_bindings, knowledge.graph.query`
...
| `knowledge.provider.source_bindings` | `ready` | `/api/provider/source-bindings` | `present` |
