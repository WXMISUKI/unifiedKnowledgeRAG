...
- Generated At: `2026-06-01T13:01:28.518106+00:00`
...
| `provider_handoff_bundle` | `True` | `ready` | artifact_present=true; status=review; artifact_count=37 | `no_action_required` |
