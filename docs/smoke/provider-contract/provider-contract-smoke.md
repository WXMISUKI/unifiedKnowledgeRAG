...
- Status: `passed`
- Generated At: `2026-05-30T03:06:55.327327+00:00`
- Checks: `7/7` passed
...
| `provider_preflight` | `GET /api/provider/preflight` | `passed` | `{"contract_version": "knowledge-provider-contract-v1", "check_count": 5, "graph_status": "planned"}` |
