...
def health() -> HealthResponse:
    ...
    answer_status, answer_reason, answer_backend, _answer_model = answer_composer_readiness(settings)
    ...
    service_status = (
        "ok"
        if backend_status == "ready" and index_status == "ready" and answer_status == "ready"
        else "degraded"
    )
