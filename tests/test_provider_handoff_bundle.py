...
def test_provider_handoff_bundle_summarizes_default_evidence():
    ...
    assert artifacts["phase12d_pgvector_live_probe_readiness"]["present"] is True
    assert artifacts["phase12d_pgvector_live_probe_readiness"]["required"] is False
    assert artifacts["phase12d_pgvector_live_probe_readiness"]["status"] == "blocked"
    ...
    assert artifacts["phase12f_pgvector_local_live_probe_execution_readiness"]["present"] is True
    assert artifacts["phase12f_pgvector_local_live_probe_execution_readiness"]["required"] is False
    assert artifacts["phase12f_pgvector_local_live_probe_execution_readiness"]["status"] in {
        "ready",
        "review",
        "blocked",
    }
